...
// Convert an ISO country code like "CM" to its flag emoji using the
// regional indicator symbol trick. Runs at module load once per code.
...
const RAW: Array<[string, string]> = [
  ...
  ['CD', 'Congo (Kinshasa)'],                       ['CR', 'Costa Rica'],
